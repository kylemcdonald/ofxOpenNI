...
#define ONI_PLATFORM_XBOX360 2
#define ONI_PLATFORM_PS3 3
#define ONI_PLATFORM_WII 4
#define ONI_PLATFORM_LINUX_X86 5
#define ONI_PLATFORM_FILES_ONLY 6
#define ONI_PLATFORM_ARC 6
#define ONI_PLATFORM_LINUX_ARM 7
#define ONI_PLATFORM_MACOSX 8
#define ONI_PLATFORM_ANDROID_ARM 9

// Endianity
#define ONI_PLATFORM_IS_LITTLE_ENDIAN 1
#define ONI_PLATFORM_IS_BIG_ENDIAN    2
